...
d3.json(`/tvtstats`).then(function(data) {
	...
	const nameTwo = [];
	const bpmTwo = [];
	const categories = ["PG", "SG", "SF", "PF", "C"];
	for (var i=0; i < data.length; i +=2){
		// console.log(value);
		
		nameOne.push(data[i].name);
		bpmOne.push(data[i]['info']['BPM']);
	...
	for (var j=1; j < data.length; j +=2){
		...
		nameTwo.push(data[j].name);
		bpmTwo.push(data[j]['info']['BPM']);
		// console.log(value['info']['BPM']);
	};
	var traceA = {
		x: categories,
...
function autocomplete(inp, arr) {
  ...
  autocomplete(document.getElementById("tvt1"), roster);
  autocomplete(document.getElementById("tvt2"), roster);
  autocomplete(document.getElementById("tvt3"), roster);
  autocomplete(document.getElementById("tvt4"), roster);
  autocomplete(document.getElementById("tvt5"), roster);
  autocomplete(document.getElementById("tvt6"), roster);
  autocomplete(document.getElementById("tvt7"), roster);
  autocomplete(document.getElementById("tvt8"), roster);
  autocomplete(document.getElementById("tvt9"), roster);
  autocomplete(document.getElementById("tvt10"), roster);
